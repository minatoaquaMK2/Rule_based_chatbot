...
validators = {
    ('ask', 'POST'): {'json': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'hello'}}}},
}

filters = {
    ('ask', 'POST'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'hello'}}}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'description': 'The user ID'}}}}},
}
