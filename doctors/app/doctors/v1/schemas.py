...
definitions = {'definitions': {'doctor': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'Jessica Wong'}, 'location': {'type': 'string', 'example': 'Mascot'}, 'specialization': {'type': 'string', 'example': 'Orthodontics'}}}}, 'parameters': {}}

validators = {
    ('doctors', 'POST'): {'json': {'$ref': '#/definitions/doctor'}},
}

filters = {
    ('doctors', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'doctors': {'type': 'array', 'items': {'type': 'string', 'example': 'John'}}}}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'error message'}}}}},
    ('doctors', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/doctor'}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'error message'}}}}},
    ('doctors_doctor_name', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/doctor'}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'error message'}}}}},
}
